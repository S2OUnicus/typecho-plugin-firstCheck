...
スクリーンショットを追加する場合は、以下のような構成がおすすめです。
...
README 上では次のように表示できます。

```markdown
![FirstCheck dark mode](assets/screenshot-dark.png)
```
...
```bash
git clone https://github.com/<your-name>/FirstCheck.git
```
...
ライセンスを決めてから、`LICENSE` ファイルを追加してください。
...
Typecho 本体や利用している外部ライブラリのライセンスも確認したうえで選択してください。
